...
- Priority-A evidence packets remain 7/7 complete. Priority-B CBCs do not gain fabricated evidence packets; their human-review gate is satisfied by the same single-reviewer clinical review (practicing ECMO specialist, project author). Independent external review (facility ECMO educator) is required before external-training/go-live.
